<template>
  <div class="rate">
    <mt-header fixed class="header" title="费用说明">
    ...
    <div class="">
      ...
      <p class="indent color666">卡还王的到账金额即是申请金额，不收取信审费、管理费、平台费等额外费用。贷款费用按实际贷款天数收取，日息因客户资质差异分为0.3‰、0.4‰、0.5‰、0.6‰、0.98‰五档。贷款期限可分为6个月和12个月，也可一次性还清欠款，需另外收取全部贷款金额的3%作为提前还款违约金。</p>
    </div>
    <div>
      <h1 class="rate-title color333">二、逾期费用说明</h1>
      <p class="indent color666">当您贷款未按期还款时，我们将根据贷款金额的不同，按日收取逾期综合费用。收取规则如下：</p>
      <ul class="overdue-fee-list color666">
        ...
        <li>
          <div>5000元~10000元（含）</div>
          <div>10元</div>
        </li>
        <li>
          <div>10000元~15000元（含）</div>
          <div>15元</div>
        </li>
        <li>
      ...
      <h1 class="color333">贷款金额+利息(贷款金额*日息*借款天数)+逾期综合费用</h1>
    </div>
